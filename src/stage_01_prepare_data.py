...
def main(config_path, params_path):
    ...
    encode = "utf8"
    with open(source_data_path, encoding=encode) as fd_in: # Actual Input data and reading
        with open(train_data_path, "w", encoding=encode) as fd_out_train: # Wrting train data
